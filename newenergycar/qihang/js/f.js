		...
		i.setPath("https://dup.baidustatic.com/"), i.define({
			...
			computeViewStatus: function(t) {
				...
				if(this.winFocused) try {
					...
					r = this.getOpacity(t), n = d.top >= 0 && d.bottom <= a && d.left >= 0 && d.left <= s;
